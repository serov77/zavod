...
<div class="modal-content">
    ...
    <div class="modal-body" id="mesto_body">
        ...
        <c:if test="${!empty vagon.rodVagona.id}">
            <input type="hidden" id="idRV" name="idRV" value="${vagon.rodVagona.id}">
        </c:if>
        <c:if test="${empty vagon.rodVagona.id}">
            <input type="hidden" id="idRV" name="idRV" value="0">
        </c:if>
        <form:hidden path="id"/>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <form:select path="rodVagona.id" id="rodVagona" data-live-search="true" class="selectpicker form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <form:input path="tara" class="form-control vagon_edit" oninput="Ftest_vagon_edit (this)"/>
            </div>
        </div>
        <div class="form-group">
            <form:label path="gruzopodyomnost" class="col-xs-4 control-label">Грузоподъемность</form:label>
            <div class="col-xs-8">
                <form:input path="gruzopodyomnost" class="form-control vagon_edit" oninput="Ftest_vagon_edit (this)"/>
            </div>
        </div>
        <div class="form-group">
            <form:label path="kolichestvoZpu" class="col-xs-4 control-label">Количество ЗПУ</form:label>
            <div class="col-xs-8">
                <form:select path="kolichestvoZpu" class="form-control selectpicker show-tick">
        ...
        <input id="dataDobavleniya_2" type="hidden"
               value="<joda:format value="${vagon.dataDobavleniya}" pattern="yyyy-MM-dd"/>">
        <c:if test="${!empty vagon.dataDobavleniya}">
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <div class="form-control"><joda:format value="${vagon.dataDobavleniya}" pattern="dd.MM.yyyy"/></div>
                </div>
            </div>
        </c:if>
