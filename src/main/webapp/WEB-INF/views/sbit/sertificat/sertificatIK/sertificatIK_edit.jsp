...
<c:if test="${empty sertificat.pogruzkaIKs}">
    <script src="<c:url value="/resources/js/sbit/sertificat/sertificatIK/sertificatIK_edit.js"/>"></script>
</c:if>
<c:if test="${!empty sertificat.pogruzkaIKs}">
    <script src="<c:url value="/resources/js/sbit/sertificat/sertificatIK/sertificatIK_edit_isp.js"/>"></script>
</c:if>