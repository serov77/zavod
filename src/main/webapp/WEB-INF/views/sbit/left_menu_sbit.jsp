...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    <ul class="nav nav-pills nav-stacked">
        <li role="presentation"><a href="#" onclick="showSbit('rod_vagona/all')"><span>Род Вагона</span></a></li>
        <li role="presentation"><a href="#" onclick="showSbit('vagon/all')"><span>Вагоны</span></a></li>
